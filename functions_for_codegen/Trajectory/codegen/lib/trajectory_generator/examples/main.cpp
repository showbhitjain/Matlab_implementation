...
int main(int, char **)
{
  ...
  main_orientationTrajectory(classInstance);
  main_positionTrajectory(classInstance);
...
// Return Type  : void
//
void main_orientationTrajectory(trajectoryGeneration::Trajectory *instancePtr)
{
  ...
  // Initialize function 'orientationTrajectory' input arguments.
  ...
  // Call the entry-point 'orientationTrajectory'.
  instancePtr->orientationTrajectory(
...
// Return Type  : void
//
void main_positionTrajectory(trajectoryGeneration::Trajectory *instancePtr)
{
  ...
  coder::array<char, 2U> trajType;
  // Initialize function 'positionTrajectory' input arguments.
  ...
  // Call the entry-point 'positionTrajectory'.
  instancePtr->positionTrajectory(waypoints_tmp, waypointTimes,
