                 ...
                 const mxArray *prhs[])
{
  ...
  case 0:
    unsafe_orientationTrajectory_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  case 1:
    unsafe_positionTrajectory_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  }
  // Module termination.
                                              ...
                                              const mxArray *prhs[4])
{
  ...
  b_prhs[2] = prhs[2];
  b_prhs[3] = prhs[3];
  orientationTrajectory_api(b_prhs, nlhs, outputs);
                                           ...
                                           int32_T nrhs, const mxArray *prhs[6])
{
  ...
  positionTrajectory_api(b_prhs, nlhs, outputs);
  // Copy over outputs to the caller.
  if (nlhs < 1) {
    i1 = 1;
  } else {
