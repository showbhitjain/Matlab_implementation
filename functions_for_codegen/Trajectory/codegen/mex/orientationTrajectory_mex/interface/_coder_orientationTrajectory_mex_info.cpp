...
//
// _coder_orientationTrajectory_mex_info.cpp
//
// Code generation for function 'orientationTrajectory'
//

// Include files
#include "_coder_orientationTrajectory_mex_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name",
                emlrtMxCreateString("orientationTrajectory"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739551.84513888892));
  emlrtSetField(xEntryPoints, 0, "Constructor",
                emlrtMxCreateLogicalScalar(false));
  emlrtSetField(xEntryPoints, 0, "Visible", emlrtMxCreateLogicalScalar(true));
  xInputs = emlrtCreateLogicalMatrix(1, 6);
  emlrtSetField(xEntryPoints, 1, "Name",
                emlrtMxCreateString("positionTrajectory"));
  ...
  emlrtSetField(xEntryPoints, 1, "TimeStamp",
                emlrtMxCreateDoubleScalar(739551.84457175923));
...
// End of code generation (_coder_orientationTrajectory_mex_info.cpp)
