...
// File: _coder_inverseKinematics_api.cpp
//
                           ...
                           const mxArray *plhs[2])
{
  ...
  *(real_T **)&xd_eff_vel_data =
  ...
  inverseKinematics(joint_values, jacobi, *xd_eff_vel_data,
                    *(int32_T(*)[1]) & xd_eff_vel_size, jointminvalues,
                    jointmaxvalues, joint_min_vel, joint_max_vel, &config,
...
void inverseKinematics_atexit()
{
  ...
  inverseKinematics_xil_terminate();
  inverseKinematics_xil_shutdown();
...
//
// File trailer for _coder_inverseKinematics_api.cpp
//
// [EOF]
//
