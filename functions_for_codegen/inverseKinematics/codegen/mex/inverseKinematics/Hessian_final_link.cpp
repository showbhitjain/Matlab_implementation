...
static emlrtBCInfo k_emlrtBCI{
    ...
    "inematics/Hessian_final_link.m", // pName
    0                                 // checkKind
};
...
static void ft_1(const real_T ct[362], real_T Hessian[294])
{
  ...
  real_T t926_tmp;
  real_T t959;
  covrtLogFcn(&emlrtCoverageInstance, 6, 1);
...
static void ft_2(const real_T ct[526], real_T Hessian[294])
{
  ...
  real_T t998;
  real_T t_ct_tmp;
  covrtLogFcn(&emlrtCoverageInstance, 6, 2);
...
void Hessian_final_link(const emlrtStack &sp,
                        const coder::array<real_T, 2U> &in1,
                        real_T Hessian[294])
{
  real_T b_t10[362];
  real_T t10;
  ...
  if (in1.size(1) < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in1.size(1), &k_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta1 = in1[0];
  if (in1.size(1) < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, in1.size(1), &l_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta2 = in1[1];
  if (in1.size(1) < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in1.size(1), &m_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta3 = in1[2];
  if (in1.size(1) < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in1.size(1), &n_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta4 = in1[3];
  if (in1.size(1) < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in1.size(1), &o_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta5 = in1[4];
  if (in1.size(1) < 6) {
    emlrtDynamicBoundsCheckR2012b(6, 1, in1.size(1), &p_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta6 = in1[5];
