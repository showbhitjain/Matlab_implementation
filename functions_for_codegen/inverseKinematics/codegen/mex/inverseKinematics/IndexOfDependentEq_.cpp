...
void IndexOfDependentEq_(const emlrtStack &sp, array<int32_T, 1U> &depIdx,
                         int32_T mFixed, int32_T nDep, d_struct_T &qrmanager,
                         int32_T mRows, int32_T nCols)
{
  ...
  for (int32_T idx{0}; idx < mFixed; idx++) {
    ...
    if ((idx + 1 < 1) || (idx + 1 > i)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &bb_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
  ...
  for (int32_T idx{a}; idx <= nCols; idx++) {
    i = qrmanager.jpvt.size(0);
    if ((idx < 1) || (idx > i)) {
      emlrtDynamicBoundsCheckR2012b(idx, 1, i, &bb_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
  ...
  for (int32_T idx{0}; idx < nDep; idx++) {
    ...
    a = ((nCols - nDep) + idx) + 1;
    if ((a < 1) || (a > i)) {
      emlrtDynamicBoundsCheckR2012b(a, 1, i, &bb_emlrtBCI, (emlrtConstCTX)&sp);
    }
    i1 = depIdx.size(0);
    if ((idx + 1 < 1) || (idx + 1 > i1)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i1, &bb_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
