...
static emlrtBCInfo e_emlrtBCI{
    ...
    "inematics/Jacobi_final_link.m", // pName
    0                                // checkKind
};
...
void Jacobi_final_link(const emlrtStack &sp,
                       const coder::array<real_T, 2U> &in1, real_T J[42])
{
  real_T et41;
  real_T et43;
  real_T t10;
  ...
  if (in1.size(1) < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in1.size(1), &e_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta1 = in1[0];
  if (in1.size(1) < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, in1.size(1), &f_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta2 = in1[1];
  if (in1.size(1) < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in1.size(1), &g_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta3 = in1[2];
  if (in1.size(1) < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in1.size(1), &h_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta4 = in1[3];
  if (in1.size(1) < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in1.size(1), &i_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta5 = in1[4];
  if (in1.size(1) < 6) {
    emlrtDynamicBoundsCheckR2012b(6, 1, in1.size(1), &j_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta6 = in1[5];
