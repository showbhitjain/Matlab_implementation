  ...
  if (nActiveConstr > 0) {
    ...
    for (nDepIneq = 0; nDepIneq < nActiveConstr; nDepIneq++) {
      ...
      for (TYPE = 0; TYPE < nVar_tmp; TYPE++) {
        ...
        if ((i1 < 1) || (i1 > i)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, i, &ac_emlrtBCI, &st);
        }
        i = qrmanager.QR.size(0) * qrmanager.QR.size(1);
        i2 = (nDepIneq + qrmanager.ldq * TYPE) + 1;
        if ((i2 < 1) || (i2 > i)) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, i, &ac_emlrtBCI, &st);
        }
        ...
        if (i1 != 0) {
          ...
          if (i2 <= i1) {
            if ((workingset.nActiveConstr == i1) || (i2 == i1)) {
              ...
              if ((i2 < 1) || (i2 > i1)) {
                emlrtDynamicBoundsCheckR2012b(i2, 1, i1, &cc_emlrtBCI, &b_st);
              }
              ...
              if (i2 > i1) {
                emlrtDynamicBoundsCheckR2012b(i2, 1, i1, &vb_emlrtBCI, &c_st);
              }
              ...
              if ((i1 < 1) || (i1 > 6)) {
                emlrtDynamicBoundsCheckR2012b(i1, 1, 6, &wb_emlrtBCI, &c_st);
              }
              ...
              if ((TYPE < 1) || (TYPE > 5)) {
                emlrtDynamicBoundsCheckR2012b(TYPE, 1, 5, &yb_emlrtBCI, &c_st);
              }
              ...
              if ((nActiveConstr < 1) || (nActiveConstr > 6)) {
                emlrtDynamicBoundsCheckR2012b(nActiveConstr, 1, 6, &dc_emlrtBCI,
                                              &b_st);
              }
              ...
              workingset.nActiveConstr--;
              if ((TYPE < 1) || (TYPE > 5)) {
                emlrtDynamicBoundsCheckR2012b(TYPE, 1, 5, &ec_emlrtBCI, &b_st);
              }
              workingset.nWConstr[TYPE - 1]--;
            }
          }
  ...
  if ((nDepInd != -1) && (workingset.nActiveConstr <= qrmanager.ldq)) {
    ...
    if ((workingset.nWConstr[2] + workingset.nWConstr[3]) +
      ...
      for (idx = 0; idx < i; idx++) {
        ...
        if ((idx + 1 < 1) || (idx + 1 > i1)) {
          emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i1, &bc_emlrtBCI, &st);
        }
      ...
      for (idx = nDepIneq; idx <= nActiveConstr; idx++) {
        i1 = qrmanager.jpvt.size(0);
        if ((idx < 1) || (idx > i1)) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, i1, &bc_emlrtBCI, &st);
        }
      ...
      for (idx = workingset.nActiveConstr; idx > nVar_tmp; idx--) {
        ...
        if ((nDepIneq < 1) || (nDepIneq > i1)) {
          emlrtDynamicBoundsCheckR2012b(nDepIneq, 1, i1, &bc_emlrtBCI, &st);
        }
      ...
      if (idx <= workingset.nVar) {
        ...
        while ((!exitg1) && (idx > i)) {
          ...
          if ((nActiveConstr < 1) || (nActiveConstr > i1)) {
            emlrtDynamicBoundsCheckR2012b(nActiveConstr, 1, i1, &bc_emlrtBCI,
                                          &st);
          }
      ...
      for (idx = nDepIneq; idx >= 1; idx--) {
        ...
        if ((i < 1) || (i > 6)) {
          emlrtDynamicBoundsCheckR2012b(i, 1, 6, &wb_emlrtBCI, &b_st);
        }
        ...
        i2 = (workingset.isActiveIdx[workingset.Wid[i1 - 1] - 1] +
             ...
             1;
        if ((i2 < 1) || (i2 > i)) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, i, &vb_emlrtBCI, &b_st);
        }
        ...
        workingset.nActiveConstr--;
        if ((TYPE < 1) || (TYPE > 5)) {
          emlrtDynamicBoundsCheckR2012b(TYPE, 1, 5, &yb_emlrtBCI, &b_st);
        }
        workingset.nWConstr[TYPE - 1]--;
      }
    }
