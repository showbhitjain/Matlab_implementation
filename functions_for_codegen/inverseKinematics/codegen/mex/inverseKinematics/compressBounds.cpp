    ...
    if (lb.size(0) != 0) {
      ...
      for (int32_T idx{0}; idx < nVar; idx++) {
        ...
        if ((idx + 1 < 1) || (idx + 1 > lb.size(0))) {
          emlrtDynamicBoundsCheckR2012b(idx + 1, 1, lb.size(0), &w_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        d = lb[idx];
        guard1 = false;
        if ((!muDoubleScalarIsInf(d)) && (!muDoubleScalarIsNaN(d))) {
          ...
          if (idx + 1 > ub.size(0)) {
            emlrtDynamicBoundsCheckR2012b(idx + 1, 1, ub.size(0), &w_emlrtBCI,
                                          (emlrtConstCTX)&sp);
          }
          if (muDoubleScalarAbs(d - ub[idx]) < 1.0E-6) {
            ...
            if ((mFixed < 1) || (mFixed > i)) {
              emlrtDynamicBoundsCheckR2012b(mFixed, 1, i, &w_emlrtBCI,
                                            (emlrtConstCTX)&sp);
            }
            ...
            i = indexLB.size(0);
            if ((mLB < 1) || (mLB > i)) {
              emlrtDynamicBoundsCheckR2012b(mLB, 1, i, &w_emlrtBCI,
                                            (emlrtConstCTX)&sp);
            }
            indexLB[mLB - 1] = idx + 1;
            if (idx + 1 > lb.size(0)) {
        ...
        if (guard1) {
          ...
          if ((!muDoubleScalarIsInf(d)) && (!muDoubleScalarIsNaN(d))) {
            ...
            i = indexUB.size(0);
            if ((mUB < 1) || (mUB > i)) {
              emlrtDynamicBoundsCheckR2012b(mUB, 1, i, &w_emlrtBCI,
                                            (emlrtConstCTX)&sp);
            }
            indexUB[mUB - 1] = idx + 1;
            if (idx + 1 > ub.size(0)) {
