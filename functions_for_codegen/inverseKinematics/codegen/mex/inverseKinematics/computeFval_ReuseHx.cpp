                           ...
                           const array<real_T, 1U> &x)
{
  ...
  case 5:
    if ((obj.nvar < 1) || (obj.nvar > x.size(0))) {
      emlrtDynamicBoundsCheckR2012b(obj.nvar, 1, x.size(0), &xc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
  ...
  case 3: {
    if (obj.hasLinear) {
      ...
      for (int32_T i{0}; i < a_tmp; i++) {
        ...
        b_i = obj.Hx.size(0);
        if ((i + 1 < 1) || (i + 1 > b_i)) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, b_i, &xc_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (i + 1 > f.size(0)) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, f.size(0), &xc_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (i + 1 > idx) {
          emlrtDynamicBoundsCheckR2012b(i + 1, 1, idx, &xc_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
  ...
  default: {
    ...
    if (obj.hasLinear) {
      ...
      for (int32_T i{0}; i < a_tmp; i++) {
        ...
        b_i = (obj.nvar + i) + 1;
        if ((b_i < 1) || (b_i > idx)) {
          emlrtDynamicBoundsCheckR2012b(b_i, 1, idx, &xc_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
      ...
      for (int32_T idx{a_tmp}; idx <= maxRegVar_tmp; idx++) {
        if ((idx < 1) || (idx > x.size(0))) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, x.size(0), &xc_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        val += x[idx - 1] * obj.rho;
      }
