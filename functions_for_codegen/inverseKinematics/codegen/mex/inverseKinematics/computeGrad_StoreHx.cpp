                         ...
                         const array<real_T, 1U> &x)
{
  ...
  case 5: {
    ...
    for (int32_T iy{0}; iy <= a_tmp - 2; iy++) {
      i = obj.grad.size(0);
      if ((iy + 1 < 1) || (iy + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(iy + 1, 1, i, &wc_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      obj.grad[iy] = 0.0;
    }
    ...
    if ((obj.nvar < 1) || (obj.nvar > i)) {
      emlrtDynamicBoundsCheckR2012b(obj.nvar, 1, i, &wc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
  ...
  default: {
    ...
    for (idx = a_tmp; idx <= maxRegVar_tmp; idx++) {
      if ((idx < 1) || (idx > x.size(0))) {
        emlrtDynamicBoundsCheckR2012b(idx, 1, x.size(0), &wc_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i = obj.Hx.size(0);
      if (idx > i) {
        emlrtDynamicBoundsCheckR2012b(idx, 1, i, &wc_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
