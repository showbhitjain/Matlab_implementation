  ...
  if (mNull_tmp <= 0) {
    ...
    for (int32_T LDimSizeP1{0}; LDimSizeP1 < order; LDimSizeP1++) {
      ...
      if ((LDimSizeP1 + 1 < 1) || (LDimSizeP1 + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(LDimSizeP1 + 1, 1, i, &cd_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
    ...
    if (qrmanager.ncols <= 0) {
      ...
      if (objective.objtype == 5) {
        ...
        for (LDimSizeP1 = 0; LDimSizeP1 < mNull_tmp; LDimSizeP1++) {
          ...
          if ((i1 < 1) || (i1 > i)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, i, &cd_emlrtBCI,
                                          (emlrtConstCTX)&sp);
          }
          ...
          for (LD_diagOffset = 0; LD_diagOffset < mNull_tmp; LD_diagOffset++) {
            ...
            for (LDimSizeP1 = k; LDimSizeP1 <= order; LDimSizeP1++) {
              ...
              if ((LDimSizeP1 < 1) || (LDimSizeP1 > i)) {
                emlrtDynamicBoundsCheckR2012b(LDimSizeP1, 1, i, &dd_emlrtBCI,
                                              &st);
              }
        ...
        if (alwaysPositiveDef) {
          ...
          if ((i1 < 1) || (i1 > i)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, i, &bd_emlrtBCI, &b_st);
          }
