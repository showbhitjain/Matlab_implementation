...
namespace coder {
namespace QRManager {
void deleteColMoveEnd(const emlrtStack &sp, d_struct_T &obj, int32_T idx)
{
  emlrtStack b_st;
  emlrtStack c_st;
  emlrtStack st;
  ...
  if (obj.usedPivoting) {
    ...
    while ((!exitg1) && (i <= obj.ncols)) {
      b_i = obj.jpvt.size(0);
      if ((i < 1) || (i > b_i)) {
        emlrtDynamicBoundsCheckR2012b(i, 1, b_i, &ad_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      if (obj.jpvt[i - 1] != idx) {
        i++;
  ...
  if (idx >= obj.ncols) {
    ...
    if ((obj.ncols < 1) || (obj.ncols > b_i)) {
      emlrtDynamicBoundsCheckR2012b(obj.ncols, 1, b_i, &ad_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    b_i = obj.jpvt.size(0);
    if ((idx < 1) || (idx > b_i)) {
      emlrtDynamicBoundsCheckR2012b(idx, 1, b_i, &ad_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    b_i = obj.ncols - 1;
    ...
    for (k = 0; k < i; k++) {
      ...
      if ((temp_tmp < 1) || (temp_tmp > i1)) {
        emlrtDynamicBoundsCheckR2012b(temp_tmp, 1, i1, &ad_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i1 = obj.QR.size(0) * obj.QR.size(1);
      ix = (k + obj.ldq * (idx - 1)) + 1;
      if ((ix < 1) || (ix > i1)) {
        emlrtDynamicBoundsCheckR2012b(ix, 1, i1, &ad_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
    ...
    if (idx < obj.mrows) {
      ...
      while (k >= idx) {
        ...
        i1 = k + idxRotGCol;
        if ((i1 < 1) || (i1 > b_i)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, b_i, &ad_emlrtBCI, &st);
        }
        temp = obj.QR[i1 - 1];
        b_i = obj.QR.size(0) * obj.QR.size(1);
        if ((i1 + 1 < 1) || (i1 + 1 > b_i)) {
          emlrtDynamicBoundsCheckR2012b(i1 + 1, 1, b_i, &ad_emlrtBCI, &st);
        }
        d = obj.QR[i1];
        ...
        b_i = obj.QR.size(0) * obj.QR.size(1);
        if (i1 > b_i) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, b_i, &ad_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        obj.QR[i1 - 1] = temp;
        b_i = obj.QR.size(0) * obj.QR.size(1);
        if ((i1 + 1 < 1) || (i1 + 1 > b_i)) {
          emlrtDynamicBoundsCheckR2012b(i1 + 1, 1, b_i, &ad_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        obj.QR[i1] = d;
        b_i = obj.QR.size(0) * obj.QR.size(1);
        ...
        if ((temp_tmp < 1) || (temp_tmp > b_i)) {
          emlrtDynamicBoundsCheckR2012b(temp_tmp, 1, b_i, &ad_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
      ...
      for (k = b_i; k <= endIdx; k++) {
        ...
        if ((temp_tmp < 1) || (temp_tmp > i1)) {
          emlrtDynamicBoundsCheckR2012b(temp_tmp, 1, i1, &ad_emlrtBCI, &st);
        }
        temp = obj.QR[temp_tmp - 1];
        i1 = obj.QR.size(0) * obj.QR.size(1);
        if ((temp_tmp + 1 < 1) || (temp_tmp + 1 > i1)) {
          emlrtDynamicBoundsCheckR2012b(temp_tmp + 1, 1, i1, &ad_emlrtBCI, &st);
        }
        d = obj.QR[temp_tmp];
        b_st.site = &vd_emlrtRSI;
        c = 0.0;
        ...
        i1 = obj.QR.size(0) * obj.QR.size(1);
        if ((temp_tmp + 1 < 1) || (temp_tmp + 1 > i1)) {
          emlrtDynamicBoundsCheckR2012b(temp_tmp + 1, 1, i1, &ad_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        obj.QR[temp_tmp] = d;
        i = k * (obj.ldq + 1);
