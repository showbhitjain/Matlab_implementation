...
boolean_T feasibleX0ForWorkingSet(const emlrtStack &sp,
                                  ...
                                  j_struct_T &workingset, d_struct_T &qrmanager)
{
  ptrdiff_t incx_t;
  ptrdiff_t incy_t;
  ptrdiff_t lda_t;
  ...
  if (mWConstr != 0) {
    ...
    for (offsetQR = 0; offsetQR < mWConstr; offsetQR++) {
      ...
      if ((offsetQR + 1 < 1) || (offsetQR + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(offsetQR + 1, 1, i, &gc_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i = workspace.size(0);
      if (offsetQR + 1 > i) {
      ...
      i = workspace.size(1);
      if (i < 2) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i, &gc_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i = workingset.bwset.size(0);
      if (offsetQR + 1 > i) {
    ...
    if (mWConstr >= nVar) {
      ...
      for (int32_T idx_col{0}; idx_col < nVar; idx_col++) {
        ...
        for (int32_T idx_row{0}; idx_row < mWConstr; idx_row++) {
          ...
          if ((i1 < 1) || (i1 > i)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, i, &gc_emlrtBCI,
                                          (emlrtConstCTX)&sp);
          }
      ...
      if (mWConstr * nVar == 0) {
        ...
        for (offsetQR = 0; offsetQR < nVar; offsetQR++) {
          ...
          if ((offsetQR + 1 < 1) || (offsetQR + 1 > i)) {
            emlrtDynamicBoundsCheckR2012b(offsetQR + 1, 1, i, &hc_emlrtBCI,
                                          &st);
          }
      ...
      if ((nVar >= 1) && (mWConstr >= 1)) {
        ...
        alpha1 = 1.0;
        B.set_size(&yb_emlrtRTEI, &c_st, workspace.size(0), workspace.size(1));
