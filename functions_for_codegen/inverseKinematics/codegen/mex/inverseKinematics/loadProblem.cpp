...
void loadProblem(const emlrtStack &sp, j_struct_T &obj, int32_T mEq,
  ...
  if (mEq > 0) {
    ...
    for (int32_T idx_col{0}; idx_col < i; idx_col++) {
      ...
      for (int32_T idx_row{0}; idx_row < k; idx_row++) {
        ...
        if ((i2 < 1) || (i2 > i1)) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, i1, &x_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        i1 = obj.Aeq.size(0);
        i3 = (idx_row + obj.ldA * idx_col) + 1;
        if ((i3 < 1) || (i3 > i1)) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, i1, &x_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
