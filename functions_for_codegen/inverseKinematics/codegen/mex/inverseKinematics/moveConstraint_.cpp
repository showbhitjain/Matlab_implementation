                     ...
                     int32_T idx_global_start, int32_T idx_global_dest)
{
  ...
  if ((idx_global_start < 1) || (idx_global_start > i)) {
    emlrtDynamicBoundsCheckR2012b(idx_global_start, 1, i, &fc_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  i = obj.Wid.size(0);
  if ((idx_global_dest < 1) || (idx_global_dest > i)) {
    emlrtDynamicBoundsCheckR2012b(idx_global_dest, 1, i, &fc_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  ...
  for (int32_T idx{0}; idx < b; idx++) {
    ...
    if ((i1 < 1) || (i1 > i)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, i, &fc_emlrtBCI, (emlrtConstCTX)&sp);
    }
    i = obj.ATwset.size(0);
    i2 = (idx + obj.ldA * (idx_global_dest - 1)) + 1;
    if ((i2 < 1) || (i2 > i)) {
      emlrtDynamicBoundsCheckR2012b(i2, 1, i, &fc_emlrtBCI, (emlrtConstCTX)&sp);
    }
