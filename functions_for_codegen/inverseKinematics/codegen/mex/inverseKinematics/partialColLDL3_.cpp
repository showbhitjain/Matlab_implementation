                     ...
                     int32_T NColsRemain)
{
  ...
  for (int32_T k{0}; k < 48; k++) {
    ...
    for (int32_T idx{0}; idx <= subRows; idx++) {
      ...
      if ((i < 1) || (i > 1)) {
        emlrtDynamicBoundsCheckR2012b(i, 1, 1, &fd_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i = obj.FMat.size(0) * obj.FMat.size(1);
      lda = LD_diagOffset + idx;
      if ((lda < 1) || (lda > i)) {
        emlrtDynamicBoundsCheckR2012b(lda, 1, i, &hd_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
    ...
    for (int32_T idx{0}; idx <= b; idx++) {
      i = offsetColK + idx;
      if ((i < 1) || (i > 1)) {
        emlrtDynamicBoundsCheckR2012b(i, 1, 1, &gd_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      if ((idx + 1 < 1) || (idx + 1 > 1)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, 1, &fd_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
    ...
    for (int32_T idx{0}; idx <= b; idx++) {
      if ((idx + 1 < 1) || (idx + 1 > 1)) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, 1, &gd_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i = offsetColK + idx;
      if ((i < 1) || (i > 1)) {
    ...
    if ((LD_diagOffset < 1) || (LD_diagOffset > i)) {
      emlrtDynamicBoundsCheckR2012b(LD_diagOffset, 1, i, &hd_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    ...
    if (b_tmp < NColsRemain) {
      ...
      for (int32_T idx{0}; idx < 48; idx++) {
        ...
        for (LD_diagOffset_tmp = 0; LD_diagOffset_tmp <= i;
          ...
          if ((lda < 1) || (lda > 1)) {
            emlrtDynamicBoundsCheckR2012b(lda, 1, 1, &fd_emlrtBCI,
                                          (emlrtConstCTX)&sp);
          }
          lda = obj.FMat.size(0) * obj.FMat.size(1);
          subRows = offsetColK + LD_diagOffset_tmp;
          if ((subRows < 1) || (subRows > lda)) {
            emlrtDynamicBoundsCheckR2012b(subRows, 1, lda, &hd_emlrtBCI,
                                          (emlrtConstCTX)&sp);
          }
