function [optimal_joint_velocity,Exit_Flag]  = inverseKinematicsWithconstraints(joint_values,jacobi,xd_eff_vel,jointminvalues,jointmaxvalues,joint_min_vel,joint_max_vel,J_g,b_g,config_input)
