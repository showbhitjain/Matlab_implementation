...
static void argInit_struct0_T(struct0_T &result)
{
  ...
  result.Slack_objective_weight = b_result_tmp;
  result.obstacle_avoidance_scheme = result_tmp;
  ...
  argInit_6x6_real_T(result.Slack_penalty_weightmatrix);
  for (int i{0}; i < 6; i++) {
...
int main(int, char **)
{
  inverseKinematicsMatlabObstacleAvoidance *classInstance;
  classInstance = new inverseKinematicsMatlabObstacleAvoidance;
  // Invoke the entry-point functions.
  // You can call entry-point functions multiple times.
  main_inverseKinematicsOA(classInstance);
  delete classInstance;
  return 0;
}

//
// Arguments    : inverseKinematicsMatlabObstacleAvoidance *instancePtr
// Return Type  : void
//
void main_inverseKinematicsOA(
    inverseKinematicsMatlabObstacleAvoidance *instancePtr)
{
  ...
  double dv[6];
  double Exit_Flag;
  // Initialize function 'inverseKinematicsOA' input arguments.
  ...
  // Call the entry-point 'inverseKinematicsOA'.
  argInit_6x1_real_T(dv);
  argInit_struct0_T(r);
  instancePtr->inverseKinematicsOA(
