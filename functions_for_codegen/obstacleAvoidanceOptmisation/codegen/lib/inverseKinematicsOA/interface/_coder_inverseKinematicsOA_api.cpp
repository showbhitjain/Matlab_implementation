...
// File: _coder_inverseKinematicsOA_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "inverseKinematicsOA",                                // fFunctionName
...
{
  static const int32_T dims{0};
  static const char_T *fieldNames[24]{"useObjectiveNormInfinity",
                                      "weightNormInfinity",
                                      "useObjectiveNormL2",
                                      "weightNormL2",
                                      ...
                                      "Slacklowerbound",
                                      "Slackupperbound",
                                      "Slack_penalty_weightmatrix",
                                      "Slack_objective_weight",
                                      "obstacle_avoidance_scheme",
                                      "k",
                                      "gamma",
                                      "applyVelocityDamper",
  ...
  thisId.fIdentifier = "Slack_penalty_weightmatrix";
  b_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)&sp, u, 0, 15,
                                     "Slack_penalty_weightmatrix")),
      &thisId, y.Slack_penalty_weightmatrix);
  thisId.fIdentifier = "Slack_objective_weight";
  y.Slack_objective_weight = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)&sp, u, 0, 16,
                                     "Slack_objective_weight")),
      &thisId);
  thisId.fIdentifier = "obstacle_avoidance_scheme";
  y.obstacle_avoidance_scheme = b_emlrt_marshallIn(
      sp,
  ...
  y.jointLimitGain =
      c_emlrt_marshallIn(sp,
                         emlrtAlias(emlrtGetFieldR2017b(
                             (emlrtConstCTX)&sp, u, 0, 23, "jointLimitGain")),
                         &thisId);
  emlrtDestroyArray(&u);
}
                             ...
                             const mxArray *plhs[2])
{
  ...
  emlrt_marshallIn(st, emlrtAliasP(prhs[10]), "config", config);
  // Invoke the target function
  inverseKinematicsOA(joint_values, jacobi, *xd_eff_vel, jointminvalues,
                      jointmaxvalues, joint_min_vel, joint_max_vel, J_g, b_g,
...
void inverseKinematicsOA_atexit()
{
  ...
  inverseKinematicsOA_xil_terminate();
  inverseKinematicsOA_xil_shutdown();
...
//
// File trailer for _coder_inverseKinematicsOA_api.cpp
//
// [EOF]
//
