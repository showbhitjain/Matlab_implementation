function [optimal_joint_velocity,Exit_Flag]  = inverseKinematicsOA(joint_values,jacobi,xd_eff_vel,jointminvalues,jointmaxvalues,joint_min_vel,joint_max_vel,J_g,b_g,jointVelocityWeightMatrix,config)
