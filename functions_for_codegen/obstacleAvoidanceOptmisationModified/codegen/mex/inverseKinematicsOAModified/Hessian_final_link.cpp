...
static void ft_1(const real_T ct[362], real_T Hessian[294])
{
  ...
  real_T t926_tmp;
  real_T t959;
  covrtLogFcn(&emlrtCoverageInstance, 5, 1);
...
static void ft_2(const real_T ct[526], real_T Hessian[294])
{
  ...
  real_T t998;
  real_T t_ct_tmp;
  covrtLogFcn(&emlrtCoverageInstance, 5, 2);
  ...
  std::memset(&Hessian[252], 0, 42U * sizeof(real_T));
}

void Hessian_final_link(const emlrtStack &sp, const real_T in1_data[],
                        const int32_T in1_size[2], real_T Hessian[294])
{
  real_T b_t10[362];
  real_T t10;
  real_T t100;
  ...
  if (in1_size[1] < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in1_size[1], &x_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta1 = in1_data[0];
  if (in1_size[1] < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, 1, &y_emlrtBCI, (emlrtConstCTX)&sp);
  }
  theta2 = in1_data[1];
  if (in1_size[1] < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, 2, &ab_emlrtBCI, (emlrtConstCTX)&sp);
  }
  theta3 = in1_data[2];
  if (in1_size[1] < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, 3, &bb_emlrtBCI, (emlrtConstCTX)&sp);
  }
  theta4 = in1_data[3];
  if (in1_size[1] < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, 4, &cb_emlrtBCI, (emlrtConstCTX)&sp);
  }
  theta5 = in1_data[4];
  if (in1_size[1] < 6) {
    emlrtDynamicBoundsCheckR2012b(6, 1, 5, &db_emlrtBCI, (emlrtConstCTX)&sp);
  }
  theta6 = in1_data[5];
  ...
  b_t10[26] = -t126;
  b_t10[27] = muDoubleScalarSin(theta6);
  b_t10[28] = t130;
  b_t10[29] = t131;
  ...
  b_t10[333] = -t54;
  b_t10[334] = -t60;
  b_t10[335] = muDoubleScalarCos(theta6);
  b_t10[336] = -t61;
  b_t10[337] = -t63;
...
// End of code generation (Hessian_final_link.cpp)
