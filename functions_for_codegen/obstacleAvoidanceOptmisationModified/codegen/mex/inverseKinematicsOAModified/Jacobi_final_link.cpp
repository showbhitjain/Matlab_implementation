                       ...
                       const coder::array<real_T, 2U> &in1, real_T J[42])
{
  ...
  if (in1.size(1) < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in1.size(1), &r_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta1 = in1[0];
  if (in1.size(1) < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, in1.size(1), &s_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta2 = in1[1];
  if (in1.size(1) < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in1.size(1), &t_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta3 = in1[2];
  if (in1.size(1) < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in1.size(1), &u_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta4 = in1[3];
  if (in1.size(1) < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in1.size(1), &v_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta5 = in1[4];
  if (in1.size(1) < 6) {
    emlrtDynamicBoundsCheckR2012b(6, 1, in1.size(1), &w_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  theta6 = in1[5];
