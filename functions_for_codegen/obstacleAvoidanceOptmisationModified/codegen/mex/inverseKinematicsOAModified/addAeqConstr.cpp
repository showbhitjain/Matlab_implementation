...
void addAeqConstr(const emlrtStack &sp, d_struct_T &obj, int32_T idx_local)
{
  emlrtStack b_st;
  emlrtStack st;
  int32_T totalEq;
  ...
  if ((obj.nActiveConstr == totalEq - 1) && (idx_local > obj.nWConstr[1])) {
    ...
    if ((obj.nActiveConstr < 1) || (obj.nActiveConstr > i1)) {
      emlrtDynamicBoundsCheckR2012b(obj.nActiveConstr, 1, i1, &vd_emlrtBCI,
                                    &st);
    }
    ...
    for (int32_T idx{0}; idx < b; idx++) {
      ...
      i2 = (iAeq0 + idx) + 1;
      if ((i2 < 1) || (i2 > i1)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, i1, &ae_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i1 = obj.ATwset.size(0);
      totalEq = (iAw0 + idx) + 1;
      if ((totalEq < 1) || (totalEq > i1)) {
        emlrtDynamicBoundsCheckR2012b(totalEq, 1, i1, &ae_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
    ...
    if ((idx_local < 1) || (idx_local > i1)) {
      emlrtDynamicBoundsCheckR2012b(idx_local, 1, i1, &ae_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i1 = obj.bwset.size[0];
    if ((obj.nActiveConstr < 1) || (obj.nActiveConstr > i1)) {
      emlrtDynamicBoundsCheckR2012b(obj.nActiveConstr, 1, i1, &ae_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    ...
    i1 = (obj.isActiveIdx[1] + idx_local) - 1;
    if ((i1 < 1) || (i1 > i)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, i, &ae_emlrtBCI, (emlrtConstCTX)&sp);
    }
    obj.isActiveConstr.data[i1 - 1] = true;
    i = obj.Wid.size[0];
    if ((totalEq < 1) || (totalEq > i)) {
      emlrtDynamicBoundsCheckR2012b(totalEq, 1, i, &ae_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    ...
    for (int32_T idx{0}; idx < b; idx++) {
      ...
      i1 = (iAeq0 + idx) + 1;
      if ((i1 < 1) || (i1 > i)) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, i, &ae_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i = obj.ATwset.size(0);
      i2 = (iAw0 + idx) + 1;
      if ((i2 < 1) || (i2 > i)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, i, &ae_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
    ...
    if ((idx_local < 1) || (idx_local > i)) {
      emlrtDynamicBoundsCheckR2012b(idx_local, 1, i, &ae_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i = obj.bwset.size[0];
    if (totalEq > i) {
