                    ...
                    const real_T lambda_data[], int32_T lambda_size)
{
  ...
  for (iL0 = 0; iL0 < nVar; iL0++) {
    if ((iL0 + 1 < 1) || (iL0 + 1 > grad.size(0))) {
      emlrtDynamicBoundsCheckR2012b(iL0 + 1, 1, grad.size(0), &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i = workspace.size(0);
    if (iL0 + 1 > i) {
      emlrtDynamicBoundsCheckR2012b(iL0 + 1, 1, i, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
  ...
  for (int32_T idx{0}; idx < mFixed; idx++) {
    ...
    if ((finiteFixed[idx] < 1) || (finiteFixed[idx] > i)) {
      emlrtDynamicBoundsCheckR2012b(finiteFixed[idx], 1, i, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    if ((idx + 1 < 1) || (idx + 1 > lambda_size)) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, lambda_size, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i = workspace.size(0);
    if ((finiteFixed[idx] < 1) || (finiteFixed[idx] > i)) {
    ...
    workspace[finiteFixed[idx] - 1] =
        workspace[finiteFixed[idx] - 1] + lambda_data[idx];
  }
  st.site = &if_emlrtRSI;
  ::coder::internal::blas::xgemv(nVar, mEq, AeqTrans, ldA, lambda_data,
                                 mFixed + 1, workspace);
  iL0 = (mFixed + mEq) + 1;
  st.site = &if_emlrtRSI;
  ::coder::internal::blas::xgemv(nVar, mIneq, AineqTrans, ldA, lambda_data, iL0,
                                 workspace);
  iL0 += mIneq;
  st.site = &if_emlrtRSI;
  if (mLB > 2147483646) {
  ...
  for (int32_T idx{0}; idx < mLB; idx++) {
    if ((idx + 1 < 1) || (idx + 1 > finiteLB.size(0))) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, finiteLB.size(0), &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i = workspace.size(0);
    if ((finiteLB[idx] < 1) || (finiteLB[idx] > i)) {
      emlrtDynamicBoundsCheckR2012b(finiteLB[idx], 1, i, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i = iL0 + idx;
    if ((i < 1) || (i > lambda_size)) {
      emlrtDynamicBoundsCheckR2012b(i, 1, lambda_size, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i1 = workspace.size(0);
    if ((finiteLB[idx] < 1) || (finiteLB[idx] > i1)) {
      emlrtDynamicBoundsCheckR2012b(finiteLB[idx], 1, i1, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    workspace[finiteLB[idx] - 1] =
        workspace[finiteLB[idx] - 1] - lambda_data[i - 1];
  }
  if (mLB - 1 >= 0) {
    iL0 += mLB;
  }
  ...
  for (int32_T idx{0}; idx < mUB; idx++) {
    if ((idx + 1 < 1) || (idx + 1 > finiteUB.size(0))) {
      emlrtDynamicBoundsCheckR2012b(idx + 1, 1, finiteUB.size(0), &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i = workspace.size(0);
    if ((finiteUB[idx] < 1) || (finiteUB[idx] > i)) {
      emlrtDynamicBoundsCheckR2012b(finiteUB[idx], 1, i, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    i = iL0 + idx;
    if ((i < 1) || (i > lambda_size)) {
    ...
    if ((finiteUB[idx] < 1) || (finiteUB[idx] > i1)) {
      emlrtDynamicBoundsCheckR2012b(finiteUB[idx], 1, i1, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    workspace[finiteUB[idx] - 1] =
        workspace[finiteUB[idx] - 1] + lambda_data[i - 1];
  }
}
                    ...
                    const real_T lambda_data[], int32_T lambda_size)
{
  ...
  for (iL0 = 0; iL0 < nVar; iL0++) {
    ...
    if (iL0 + 1 > workspace_tmp) {
      emlrtDynamicBoundsCheckR2012b(iL0 + 1, 1, workspace_tmp, &bc_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    workspace[iL0] = grad[iL0];
  }
