                         ...
                         const array<real_T, 1U> &x, int32_T &status)
{
  ...
  fval = c_inverseKinematicsOAModified_a(
      b_st,
      obj.next.next.next.next.next.next.next.next.value.workspace.jacobi.data,
      obj.next.next.next.next.next.next.next.next.value.workspace.jacobi.size,
      ...
      obj.next.next.next.next.next.next.next.next.value.workspace.joint_values
          .size[0],
      obj.next.next.next.next.next.next.next.next.value.workspace
          .jointVelocityWeightMatrix.data,
      obj.next.next.next.next.next.next.next.next.value.workspace
          .jointVelocityWeightMatrix.size,
