               ...
               array<int32_T, 1U> &workspace, int32_T xMax)
{
  ...
  if ((xLen > 1) && (xMax > 1)) {
    ...
    for (int32_T idx{0}; idx < xMax; idx++) {
      i = workspace.size(0);
      if (idx + 1 > i) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      workspace[idx] = 0;
    }
    ...
    for (int32_T idx{0}; idx < xLen; idx++) {
      ...
      if ((idxStart < 1) || (idxStart > i2)) {
        emlrtDynamicBoundsCheckR2012b(idxStart, 1, i2, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i2 = workspace.size(0);
      if (idx + 1 > i1) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, i1, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      if (idxStart > i2) {
        emlrtDynamicBoundsCheckR2012b(idxStart, 1, i2, &qb_emlrtBCI,
    ...
    for (int32_T idx{2}; idx <= xMax; idx++) {
      i = workspace.size(0);
      if (idx > i) {
        emlrtDynamicBoundsCheckR2012b(idx, 1, i, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i = workspace.size(0);
      if (idx - 1 > i) {
    ...
    for (int32_T idx{0}; idx <= xMax - 2; idx++) {
      ...
      for (int32_T idxFill{idxStart}; idxFill <= idxEnd; idxFill++) {
        ...
        if ((idxFill < 1) || (idxFill > i2)) {
          emlrtDynamicBoundsCheckR2012b(idxFill, 1, i2, &qb_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        x[idxFill - 1] = idx + 1;
      }
      ...
      if (idx + 2 > i1) {
        emlrtDynamicBoundsCheckR2012b(idx + 2, 1, i1, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
  ...
  if ((xLen > 1) && (xMax > xMin)) {
    ...
    for (int32_T idx{0}; idx < xLen; idx++) {
      ...
      if ((idxW < 1) || (idxW > idxEnd)) {
        emlrtDynamicBoundsCheckR2012b(idxW, 1, idxEnd, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      idxEnd = workspace.size(0);
      if (idx + 1 > idxStart) {
        emlrtDynamicBoundsCheckR2012b(idx + 1, 1, idxStart, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      if (idxW > idxEnd) {
        emlrtDynamicBoundsCheckR2012b(idxW, 1, idxEnd, &qb_emlrtBCI,
    ...
    for (idxW = 0; idxW <= b_tmp - 2; idxW++) {
      ...
      if ((idxW + 1 < 1) || (idxW + 1 > i)) {
        emlrtDynamicBoundsCheckR2012b(idxW + 1, 1, i, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      idxStart = workspace[idxW] + 1;
      i = workspace.size(0);
      if ((idxW + 2 < 1) || (idxW + 2 > i)) {
        emlrtDynamicBoundsCheckR2012b(idxW + 2, 1, i, &qb_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
