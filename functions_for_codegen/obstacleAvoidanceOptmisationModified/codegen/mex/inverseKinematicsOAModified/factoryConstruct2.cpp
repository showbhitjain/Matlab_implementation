                      ...
                      d_struct_T &obj)
{
  ...
  obj.nVarMax = nVarMax;
  obj.ldA = nVarMax;
  obj.Aineq.set_size(&fb_emlrtRTEI, &sp, mIneqMax * nVarMax);
  obj.bineq.size[0] = mIneqMax;
  obj.Aeq.set_size(&fb_emlrtRTEI, &sp, mEqMax * nVarMax);
  obj.beq.size[0] = mEqMax;
  obj.lb.set_size(&fb_emlrtRTEI, &sp, nVarMax);
  obj.ub.set_size(&fb_emlrtRTEI, &sp, nVarMax);
  obj.indexLB.set_size(&fb_emlrtRTEI, &sp, nVarMax);
  obj.indexUB.set_size(&fb_emlrtRTEI, &sp, nVarMax);
  obj.indexFixed.set_size(&fb_emlrtRTEI, &sp, nVarMax);
  obj.mEqRemoved = 0;
  obj.indexEqRemoved.size[0] = mEqMax;
  obj.ATwset.set_size(&fb_emlrtRTEI, &sp, nVarMax * mConstrMax);
