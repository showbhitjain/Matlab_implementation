                                     ...
                                     int32_T nlhs, const mxArray *plhs[2])
{
  ...
  inverseKinematicsOAModified(
      &st, joint_values, jacobi, *xd_eff_vel, jointminvalues, jointmaxvalues,
      joint_min_vel, joint_max_vel, J_g, b_g, jointVelocityWeightMatrix,
      &configInput, optimal_joint_velocity, &Exit_Flag);
