...
//
// inverseKinematicsOAModified_internal_types.h
//
...
struct d_struct_T {
  ...
  coder::bounded_array<real_T, 112U, 1U> bineq;
  ...
  coder::bounded_array<real_T, 279U, 1U> bwset;
  int32_T nActiveConstr;
  coder::bounded_array<real_T, 279U, 1U> maxConstrWorkspace;
  int32_T sizes[5];
  ...
  coder::bounded_array<boolean_T, 279U, 1U> isActiveConstr;
  coder::bounded_array<int32_T, 279U, 1U> Wid;
  coder::bounded_array<int32_T, 279U, 1U> Wlocalidx;
  int32_T nWConstr[5];
  int32_T probType;
  real_T SLACK0;
};
...
struct j_struct_T {
  ...
  coder::bounded_array<real_T, 279U, 1U> cIneq;
  coder::bounded_array<real_T, 143U, 1U> cIneq_old;
  coder::bounded_array<real_T, 279U, 1U> cEq;
  coder::bounded_array<real_T, 143U, 1U> cEq_old;
  coder::array<real_T, 1U> grad;
  coder::array<real_T, 1U> grad_old;
  int32_T FunctionEvaluations;
  int32_T sqpIterations;
  int32_T sqpExitFlag;
  coder::bounded_array<real_T, 279U, 1U> lambdasqp;
  coder::bounded_array<real_T, 405U, 1U> lambdaStopTest;
  coder::bounded_array<real_T, 405U, 1U> lambdaStopTestPrev;
  real_T steplength;
  coder::array<real_T, 1U> delta_x;
  coder::array<real_T, 1U> socDirection;
  coder::bounded_array<int32_T, 279U, 1U> workingset_old;
  coder::array<real_T, 1U> gradLag;
  coder::array<real_T, 1U> delta_gradLag;
  coder::array<real_T, 1U> xstar;
  real_T fstar;
  real_T firstorderopt;
  coder::bounded_array<real_T, 405U, 1U> lambda;
  int32_T state;
  real_T maxConstr;
  int32_T iterations;
...
// End of code generation (inverseKinematicsOAModified_internal_types.h)
