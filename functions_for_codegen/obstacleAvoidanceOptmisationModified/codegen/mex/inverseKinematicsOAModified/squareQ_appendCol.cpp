                       ...
                       const array<real_T, 1U> &vec, int32_T iv0)
{
  ...
  if ((obj.ncols < 1) || (obj.ncols > i)) {
    emlrtDynamicBoundsCheckR2012b(obj.ncols, 1, i, &ld_emlrtBCI,
                                  (emlrtConstCTX)&sp);
  }
  i = obj.ncols - 1;
  ...
  for (int32_T idx{obj.mrows}; idx > obj.ncols; idx--) {
    ...
    n = idx + obj.ldq * i;
    if ((n - 1 < 1) || (n - 1 > Qk0)) {
      emlrtDynamicBoundsCheckR2012b(n - 1, 1, Qk0, &ld_emlrtBCI, &st);
    }
    beta1 = obj.QR[n - 2];
    Qk0 = obj.QR.size(0) * obj.QR.size(1);
    if ((n < 1) || (n > Qk0)) {
      emlrtDynamicBoundsCheckR2012b(n, 1, Qk0, &ld_emlrtBCI, &st);
    }
    temp = obj.QR[n - 1];
    ...
    Qk0 = obj.QR.size(0) * obj.QR.size(1);
    if ((n - 1 < 1) || (n - 1 > Qk0)) {
      emlrtDynamicBoundsCheckR2012b(n - 1, 1, Qk0, &ld_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    obj.QR[n - 2] = beta1;
    Qk0 = obj.QR.size(0) * obj.QR.size(1);
    if (n > Qk0) {
      emlrtDynamicBoundsCheckR2012b(n, 1, Qk0, &ld_emlrtBCI,
                                    (emlrtConstCTX)&sp);
    }
    obj.QR[n - 1] = temp;
    Qk0 = obj.ldq * (idx - 2);
