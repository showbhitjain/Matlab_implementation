                 ...
                 g_struct_T &QPObjective, k_struct_T &qpoptions)
{
  ...
  do {
    ...
    case 1: {
      ...
      st.site = &wf_emlrtRSI;
      r.set_size(&vb_emlrtRTEI, &st, b_TrialState.grad.size(0));
      ...
      if (b_TrialState.state > 0) {
        ...
        constrViolationIneq = MeritFunction::computeConstrViolationIneq_(
            c_st, WorkingSet.sizes[2], b_TrialState.cIneq.data,
            b_TrialState.cIneq.size[0]);
      ...
      qpactiveset::parseoutput::sortLambdaQP(
          b_st, b_TrialState.lambda.data, b_TrialState.lambda.size[0],
          WorkingSet.nActiveConstr, WorkingSet.sizes, WorkingSet.isActiveIdx,
          WorkingSet.Wid.data, WorkingSet.Wid.size[0],
          WorkingSet.Wlocalidx.data, WorkingSet.Wlocalidx.size[0],
    ...
    case 2:
      ...
      st.site = &wf_emlrtRSI;
      step::makeBoundFeasible(st, b_TrialState.xstar, WorkingSet, lb_data,
                              lb_size, ub_data, ub_size);
      st.site = &wf_emlrtRSI;
      ...
      break;
    default:
      r.set_size(&vb_emlrtRTEI, &sp, b_TrialState.grad.size(0));
      iH0 = b_TrialState.grad.size(0);
      for (i = 0; i < iH0; i++) {
        r[i] = b_TrialState.grad[i];
      }
  ...
  if (checkBoundViolation) {
    ...
    st.site = &wf_emlrtRSI;
    r.set_size(&vb_emlrtRTEI, &st, b_TrialState.delta_x.size(0));
    ...
    if (lb_size != 0) {
      ...
      for (iH0 = 0; iH0 < b_nVar; iH0++) {
        ...
        if ((WorkingSet.indexLB[iH0] < 1) ||
            (WorkingSet.indexLB[iH0] > lb_size)) {
          emlrtDynamicBoundsCheckR2012b(WorkingSet.indexLB[iH0], 1, lb_size,
                                        &fc_emlrtBCI, &st);
        }
        ...
        constrViolationIneq =
            (b_TrialState.xstarsqp[WorkingSet.indexLB[iH0] - 1] +
             constrViolationEq) -
            lb_data[WorkingSet.indexLB[iH0] - 1];
    ...
    if (ub_size != 0) {
      ...
      for (iH0 = 0; iH0 < nVar; iH0++) {
        ...
        if ((WorkingSet.indexUB[iH0] < 1) ||
            (WorkingSet.indexUB[iH0] > ub_size)) {
          emlrtDynamicBoundsCheckR2012b(WorkingSet.indexUB[iH0], 1, ub_size,
                                        &fc_emlrtBCI, &st);
        }
        i = b_TrialState.xstarsqp.size(0);
        ...
        constrViolationIneq =
            (ub_data[WorkingSet.indexUB[iH0] - 1] -
    ...
    b_TrialState.delta_x.set_size(&vb_emlrtRTEI, &sp, r.size(0));
    iH0 = r.size(0);
    for (i = 0; i < iH0; i++) {
