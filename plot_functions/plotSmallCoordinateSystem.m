function plotSmallCoordinateSystem(T, scale,maxHeadSize)
    ...
    quiver3(transOrigin3D(1), transOrigin3D(2), transOrigin3D(3), ...
            transXAxis3D(1)-transOrigin3D(1), transXAxis3D(2)-transOrigin3D(2), transXAxis3D(3)-transOrigin3D(3), 'r', 'LineWidth', 2,'MaxHeadSize',maxHeadSize);
    quiver3(transOrigin3D(1), transOrigin3D(2), transOrigin3D(3), ...
            transYAxis3D(1)-transOrigin3D(1), transYAxis3D(2)-transOrigin3D(2), transYAxis3D(3)-transOrigin3D(3), 'g', 'LineWidth', 2,'MaxHeadSize',maxHeadSize);
    quiver3(transOrigin3D(1), transOrigin3D(2), transOrigin3D(3), ...
            transZAxis3D(1)-transOrigin3D(1), transZAxis3D(2)-transOrigin3D(2), transZAxis3D(3)-transOrigin3D(3), 'b', 'LineWidth', 2,'MaxHeadSize',maxHeadSize);
